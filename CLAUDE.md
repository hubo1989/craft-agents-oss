...
<!-- AUTO-SYNCED from AGENTS.md files - Last updated: 2026-01-27 23:29:36 -->
<!-- Source files: ./AGENTS.md -->

**Note:** The content in AGENTS.md is currently identical to the main CLAUDE.md content. The AGENTS.md file targets "iFlow AI Agent" while this file targets "Claude Code", but both contain the same Craft Agents project documentation.

If you wish to maintain separate agent-specific instructions, edit ./AGENTS.md with those rules and re-run `/sync-agent-context` to merge them here.

---

### Root Directory Agent Rules (./AGENTS.md)

*Content from AGENTS.md is already synchronized above. The file contains identical Craft Agents project documentation.*
