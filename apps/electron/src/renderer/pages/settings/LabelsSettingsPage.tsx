          ...
          <div className="px-5 py-7 max-w-3xl mx-auto">
            <div className="space-y-8">
              {isLoading ? (
                ...
                <>
                  {/* About Section */}
                  <SettingsSection title={t('labels.aboutTitle')}>
                    <SettingsCard className="px-4 py-3.5">
                      <div className="text-sm text-muted-foreground leading-relaxed space-y-1.5">
                        <p>
                          {t('labels.description1')}
                        </p>
                        <p>
                          {t('labels.description2')}
                        </p>
                        <p>
                          {t('labels.description3')}
                        </p>
                        <p>
                          <button
                            type="button"
                  ...
                  <SettingsSection
                    title={t('labels.hierarchyTitle')}
                    description={t('labels.hierarchyDescription')}
                    action={
                      <EditPopover
                        trigger={<EditButton>{t('common.edit')}</EditButton>}
                    ...
                    <SettingsCard className="p-0">
                      {labels.length > 0 ? (
                        <LabelsDataTable
                          ...
                          maxHeight={350}
                          fullscreen
                          fullscreenTitle={t('labels.hierarchyTitle')}
                        />
                      ) : (
                        <div className="p-8 text-center text-muted-foreground">
                          <p className="text-sm">{t('labels.noLabels')}</p>
                          <p className="text-xs mt-1 text-foreground/40">
                            {t('labels.noLabelsDescription')}
                          </p>
                        </div>
                      )}
                    </SettingsCard>
                  ...
                  <SettingsSection
                    title={t('labels.autoApplyRulesTitle')}
                    description={t('labels.autoApplyRulesDescription')}
                    action={
                      <EditPopover
                        trigger={<EditButton>{t('common.edit')}</EditButton>}
                  ...
                  >
                    <SettingsCard className="p-0">
                      <AutoRulesDataTable
                        ...
                        maxHeight={350}
                        fullscreen
                        fullscreenTitle={t('labels.autoApplyRulesTitle')}
                      />
                    </SettingsCard>
                  </SettingsSection>
                </>
