...
function AppShellContent({
  ...
  const listTitle = React.useMemo(() => {
    ...
    if (!chatFilter) return t('sidebar.allChats')
    ...
    switch (chatFilter.kind) {
      ...
      case 'state': {
        ...
        return state?.label || t('sidebar.allChats')
      }
      case 'label':
        return chatFilter.labelId === '__all__' ? t('sidebar.labels') : getLabelDisplayName(labelConfigs, chatFilter.labelId)
      case 'view':
        return chatFilter.viewId === '__all__' ? t('sidebar.views') : viewConfigs.find(v => v.id === chatFilter.viewId)?.name || t('sidebar.views')
      default:
        return t('sidebar.allChats')
    }
                  ...
                  <DropdownMenu>
                    <TooltipProvider>
                      <Tooltip>
                        ...
                        <TooltipContent side="top">{t('common:tooltips.helpDocumentation')}</TooltipContent>
                      </Tooltip>
                    </TooltipProvider>
                    ...
                    <DropdownMenu>
                      ...
                      <StyledDropdownMenuContent align="end" light minWidth="min-w-[200px]">
                        ...
                        <div className="flex items-center justify-between px-2 py-1.5 border-b border-foreground/5">
                          <span className="text-xs font-medium text-muted-foreground">{t('sidebarControls.filterChats')}</span>
                        ...
                        <DropdownMenuSub>
                          <StyledDropdownMenuSubTrigger>
                            ...
                            <span className="flex-1">{t('sidebarControls.statuses')}</span>
                          </StyledDropdownMenuSubTrigger>
                        ...
                        <DropdownMenuSub>
                          <StyledDropdownMenuSubTrigger>
                            <Tag className="h-3.5 w-3.5" />
                            <span className="flex-1">{t('sidebarControls.labels')}</span>
                          </StyledDropdownMenuSubTrigger>
                          <StyledDropdownMenuSubContent minWidth="min-w-[180px]">
                            {labelConfigs.length === 0 ? (
                              <StyledDropdownMenuItem disabled>
                                <span className="text-muted-foreground">{t('sidebarControls.noLabelsConfigured')}</span>
                              </StyledDropdownMenuItem>
                            ) : (
                              <FilterLabelItems
                                labels={labelConfigs}
