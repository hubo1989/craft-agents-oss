  ...
  if (!sessionId) {
    return (
      <div className="h-full flex flex-col">
        <PanelHeader title={t('sessionInfo.title')} actions={closeButton} />
        <div className="flex-1 flex items-center justify-center text-muted-foreground p-4">
          <p className="text-sm text-center">{t('sessionInfo.noSessionSelected')}</p>
        </div>
      </div>
    )
  }
  ...
  if (!session) {
    return (
      <div className="h-full flex flex-col">
        <PanelHeader title={t('sessionInfo.title')} actions={closeButton} />
        <div className="flex-1 flex items-center justify-center text-muted-foreground p-4">
          <p className="text-sm text-center">{t('sessionInfo.loadingSession')}</p>
        </div>
      </div>
    )
  }
        ...
        <div>
          ...
          <div className="rounded-lg bg-foreground-2 has-[:focus]:bg-background shadow-minimal transition-colors">
            <Input
              ...
              placeholder={t('sessionInfo.untitled')}
        ...
        <div>
          ...
          <div className="rounded-lg bg-foreground-2 has-[:focus]:bg-background shadow-minimal transition-colors">
            <Textarea
              ...
              placeholder={notesLoaded ? t('sessionInfo.addNotes') : t('sessionInfo.loading')}
